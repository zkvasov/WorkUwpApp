...
namespace WorkUwpApp.Validation
{
    ...
    public class ValidatableVmBase : ViewModelBase, IValidatableBindableBase
    {
        private readonly BindableValidator _bindableValidator;

        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatableVmBase"/> class.
        /// </summary>
        public ValidatableVmBase()
        {
        ...
        {
            var result = Set(ref storage, value, propertyName);
